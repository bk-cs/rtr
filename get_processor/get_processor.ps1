...
$Sel = @('ProcessorId', 'Caption', 'DeviceID', 'Manufacturer', 'MaxClockSpeed', 'SocketDesignation', 'Name')
$Out = gwmi Win32_Processor -EA 0 | select $Sel
output $Out $Param "get_processor.ps1"