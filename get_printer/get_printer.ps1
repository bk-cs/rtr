...
$Sel = @('Name', 'Type', 'ShareName', 'PortName', 'DriverName', 'Location', 'Shared', 'Published', 'DeviceType',
    'Priority', 'PrinterStatus')
$Out = Get-Printer -EA 0 | select $Sel
output $Out $Param "get_printer.ps1"