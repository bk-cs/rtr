...
$Sel = @('Sid', 'LocalPath', 'RoamingPath', 'RoamingConfigured', 'LastUseTime')
$Out = gwmi win32_userprofile | ? { $_.SID -match '^S-1-5-21' } | select $Sel
output $Out $Param "get_user_profile.ps1"