...
$Sel = @('Name', 'FullName', 'Enabled', 'Sid', 'PasswordRequired', 'PasswordLastSet', 'PasswordExpires',
    'PrincipalSource', 'Description')
$Out = Get-LocalUser -EA 0 | select $Sel | % {
...
output $Out $Param "get_local_user.ps1"