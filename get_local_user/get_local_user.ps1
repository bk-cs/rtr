...
$Out = Get-LocalUser -EA 0 | select Name, FullName, Enabled, Sid, PasswordRequired, PasswordLastSet,
PasswordExpires, PrincipalSource, Description | % {
...
output $Out $Param "get_local_user_$((Get-Date).ToFileTimeUtc()).json"