...
$Out = [PSCustomObject] @{ OA3xOriginalProductKey = (gwmi -Class SoftwareLicensingService).OA3xOriginalProductKey }
output $Out $Param "get_windows_key_$((Get-Date).ToFileTimeUtc()).json"