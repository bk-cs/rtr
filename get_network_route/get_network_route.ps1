...
$Sel = @('DestinationPrefix', 'InterfaceIndex', 'InterfaceAlias', 'AddressFamily', 'NextHop', 'Publish',
    'State', 'RouteMetric', 'InterfaceMetric', 'Protocol', 'PolicyStore')
$Out = Get-NetRoute -EA 0 | select $Sel
output $Out $Param "get_network_route.ps1"